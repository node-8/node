...
var Minimatch = class {
  ...
  parse(pattern) {
    ...
    if (m = pattern.match(starRE)) {
      ...
      fastTest = options.node8QmarksTest ? options.node8QmarksTest(m, options) : (options.nocase ? options.dot ? qmarksTestNocaseDot : qmarksTestNocase : options.dot ? qmarksTestDot : qmarksTest)(m);
